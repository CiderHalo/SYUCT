...
function renderChrome(){
  ...
  topbar.innerHTML = `
    ...
    <a class="brand" href="index.html" aria-label="返回首页">
      <span class="brand-mark brand-mark-logo"><img src="assets/syuct-badge.png" alt="沈阳化工大学校徽"></span>
