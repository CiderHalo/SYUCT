...
document.addEventListener("keydown",e=>{
  ...
  if(e.key==="Escape"){closeQuickLinks();closeSearch();document.getElementById("lightbox")?.classList.remove("open");document.body.classList.remove("modal-open");}
});
