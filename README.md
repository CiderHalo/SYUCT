...
当前版本：**v1.5**；共收录 **41 份文档、2 张校园地图和 1 个交流群二维码**。
...
- 首页快捷区改为“本科新生、硕士新生高频问题”，不再把课程真题作为首页高频入口。
- 新增工程管理专业 2025 培养方案和 2026 通识选修经验资料。
- 新增创新创业竞赛管理办法、2025 补充修订及开放实验室申请表。
- 新增学籍信息修改、缓考、监控录像回放和体育保健课申请表。
- 新增 2026 年暑期本科生留校工作方案，并标注时效性。
- 出于隐私保护，未将包含多位教师个人手机号的联系表纳入公开站点。
